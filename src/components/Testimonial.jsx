...
function Testimonial() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 my-32 w-11/12 md:w-8/12 mx-auto items-center bg-[#dfff9d] gap-8 md:gap-16 rounded-[3rem] p-4">
      <div>
        <img
        ...
        <div className="flex gap-3  items-center">
          ...
          <div>
            ...
            <p className="text-xs text-slate-700">
              Co-founder and CEO of Linktree
            </p>
          </div>
        </div>
      </div>
